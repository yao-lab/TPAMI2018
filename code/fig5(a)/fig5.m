...
f=F(ind,:);
common=sum(f,1);
totalcommon=sum(common);
h=bar(1:18,common./totalcommon);hold on;
axis([0 18 0 0.3]);
set(gca,'XTick',[1:1:18]); 
set(gca,'XTicklabel',{'Action','Adventure','Animation','Children','Comedy','Crime','Documentary','Drama','Fantasy','Film-Noir','Horror','Musical','Mystery','Romance','Sci-Fi','Thriller','War','Western'},'FontSize',15); 
